...
<table border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr height="40px">
    	<td colspan="4" align="right">
	        <button type="button" onclick="document.location.href='principal.php?pag=tra_mcb&ref=<?php echo $idCta; ?>';" name="btnRegresa" class="btn btn-warning  button icon arrowleft">Regresar</button>
            <button type="submit" name="btnGuarda" class="btn btn-success btn-sm approve">Guardar</button>
        </td>
    </tr>
</table>
</form>
