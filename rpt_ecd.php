...
<table border="0" width="96%" align="center" cellpadding="0" cellspacing="0">
	<tr>
        ...
        <td width="90px" align="right"><button type="submit" name="btnBusca" class="btn btn-success search">Buscar</button></td>
    </tr>
</table>
</form>
<br>
...
<table border="0" width="96%" align="center" cellpadding="0" cellspacing="0" class="lista_tabla">
    ...
    <tr height="25px">
        ...
        <td class="lista_celda" align="center"></td>
        <td class="lista_celda" align="right"><?php $tIng=0; echo number_format($tIng,2); ?></td>
        <td class="lista_celda" align="right"><?php $tEgr =0; echo number_format($tEgr,2); ?></td>
        <td class="lista_celda" align="right"><?php $iSal=0; echo number_format($iSal,2); ?></td>
