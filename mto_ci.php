...
<table border="0" width="96%" align="center" cellpadding="0" cellspacing="0">
	<tr>
        ...
        <td width="90px" align="right"><button type="button" onclick="document.location.href='principal.php?pag=<?php echo $_REQUEST['pag']; ?>_add';" name="btnNuevo" class="btn btn-primary dim">Nuevo</button></td>
    </tr>
</table>
<br>
