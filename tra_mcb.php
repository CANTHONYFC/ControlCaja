...
<table border="0" width="96%" align="center" cellpadding="0" cellspacing="0">
	<tr>
        ...
        <td width="90px" align="right"><button type="button" onclick="document.location.href='principal.php?pag=tra_mcb_add&ref=' + document.getElementById('cuenta').value;" name="btnNuevo" class="btn btn-primary">Nuevo</button></td>
    </tr>
</table>
</form>
<br>
